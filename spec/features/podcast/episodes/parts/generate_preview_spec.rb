...
describe 'Generate part preview' do
  ...
  it 'should generate preview of a part' do
    ...
    expect(Podcasts::Episodes::Parts::PreviewWorker).to have_enqueued_sidekiq_job(Podcast::Episodes::Part.last.id, concat_preview_data_output, before_file_render_command, after_file_render_command, concat_files_render_command)
  end
end
