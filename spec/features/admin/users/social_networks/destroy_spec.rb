...
describe 'Delete social_network' do
  ...
  let!(:admin) { create :admin, project_id: it_way_id }
  ...
  it 'deletes social_network' do
    ...
    click_on "#{admin.first_name} #{admin.last_name}"
    click_on 'Добавить социальные сети'

    attributes = attributes_for :social_network_admin_add_to_admin_attributes
