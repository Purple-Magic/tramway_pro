...
gem 'tramway-admin', '1.27.0.2'
gem 'tramway-api', '1.7.1.2'
gem 'tramway-auth', '1.1.0.3'
gem 'tramway-conference', '1.9.1.1'
gem 'tramway-core', '1.17.1.1'
gem 'tramway-event', '1.11.2.1'
gem 'tramway-export', '0.1.5'
gem 'tramway-landing', '2.0.1.5'
...
gem 'tramway-sport_school', '1.2.10.6'
