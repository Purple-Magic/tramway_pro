...
gem 'tramway-admin', '1.28.0.1'
gem 'tramway-api', '1.7.1.3'
gem 'tramway-auth', '1.1.0.3'
gem 'tramway-conference', '1.9.3'
gem 'tramway-core', '1.17.2.4'
gem 'tramway-event', '1.11.4.1'
gem 'tramway-export', '0.1.5'
gem 'tramway-landing', '2.0.1.6'
gem 'tramway-news', '1.0.4.3'
gem 'tramway-page', '1.3.1.1'
gem 'tramway-partner', '1.0.3.2'
gem 'tramway-profiles', '1.4.0.1'
gem 'tramway-site', '0.1.0.4'
gem 'tramway-sport_school', '1.2.11.3'
gem 'tramway-user', '2.1.3'
