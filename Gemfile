...
gem 'tramway-admin', '3.0'
gem 'tramway-api', '1.8.7.3'
gem 'tramway-conference', '1.9.5.4'
gem 'tramway-core', '3.0.0.1'
gem 'tramway-event', '1.12.6.3'
gem 'tramway-export', '0.2.0.4'
gem 'tramway-landing', '3.3.0.4'
gem 'tramway-news', '1.0.5'
gem 'tramway-page', '1.5.4.3'
