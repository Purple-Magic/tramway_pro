...
gem 'active_model_serializers', '0.10.12' # 0.10.6 breaks the returned json, need to investigate
gem 'audited', '>= 4.8.0'
gem 'bcrypt'
...
gem 'time_difference', github: 'jmortlock/time_difference'
gem 'trap', '3.0'
gem 'uglifier', '>= 1.3.0'
gem 'unicorn-rails'
gem 'uuid'
