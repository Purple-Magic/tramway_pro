...
gem 'tramway-admin', '1.30'
gem 'tramway-api', '1.8.2.3'
gem 'tramway-auth', '2.0.1'
gem 'tramway-conference', '1.9.4.3'
gem 'tramway-core', '1.18.1.2'
gem 'tramway-event', '1.12.3.4'
gem 'tramway-export', '0.1.6.1'
gem 'tramway-landing', '3.1.0.2'
gem 'tramway-news', '1.0.4.3'
gem 'tramway-page', '1.5.3.1'
gem 'tramway-partner', '1.0.3.2'
gem 'tramway-profiles', '1.4.1.1'
gem 'tramway-site', '0.1.0.4'
gem 'tramway-sport_school', '1.2.12.4'
