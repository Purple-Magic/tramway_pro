...
gem 'tramway-admin', '1.28'
gem 'tramway-api', '1.7.1.3'
gem 'tramway-auth', '1.1.0.3'
gem 'tramway-conference', '1.9.2.2'
gem 'tramway-core', '1.17.2'
...
gem 'tramway-profiles', '1.4'
gem 'tramway-site', '0.1.0.4'
gem 'tramway-sport_school', '1.2.11.2'
gem 'tramway-user', '2.1.2.1'
