...
# gem 'tramway-admin', '1.29.1.1'
# gem 'tramway-api', '1.8.1.1'
# gem 'tramway-auth', '1.2'
# gem 'tramway-conference', '1.9.4.1'
# gem 'tramway-core', '1.17.6'
# gem 'tramway-event', '1.12.1.1'
# gem 'tramway-export', '0.1.5.1'
# gem 'tramway-landing', '2.2.2.1'
# gem 'tramway-news', '1.0.4.3'
# gem 'tramway-page', '1.5.2.1'
# gem 'tramway-partner', '1.0.3.2'
# gem 'tramway-profiles', '1.4.1'
# gem 'tramway-site', '0.1.0.4'
# gem 'tramway-sport_school', '1.2.12.2'
