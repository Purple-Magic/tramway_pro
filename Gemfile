...
gem 'tramway-admin', '1.22.0.4'
gem 'tramway-api', '1.6.3'
gem 'tramway-auth', '1.1.0.2'
gem 'tramway-conference', '1.9'
gem 'tramway-core', '1.16.1.1'
gem 'tramway-event', '1.9.28'
gem 'tramway-export', '0.1.0.1'
gem 'tramway-landing', '2.0.1'
gem 'tramway-news', '1.0.4.2'
gem 'tramway-page', '1.3.1'
gem 'tramway-partner', '1.0.3.1'
gem 'tramway-profiles', '1.3.2.3'
gem 'tramway-site', '0.1.0.3'
gem 'tramway-sport_school', '1.2.10.3'
gem 'tramway-user', '2.1.1'
