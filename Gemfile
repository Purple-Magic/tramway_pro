...
gem 'tramway-admin', '1.22.0.1'
gem 'tramway-api', '1.6.3'
gem 'tramway-auth', '1.1.0.2'
gem 'tramway-conference', '1.8.14.1'
gem 'tramway-core', '1.16.1'
gem 'tramway-event', '1.9.23'
gem 'tramway-export', '0.1.0.1'
gem 'tramway-landing', '2.0.0.2'
