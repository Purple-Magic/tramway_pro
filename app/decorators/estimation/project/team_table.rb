...
module Estimation::Project::TeamTable
  ...
  TEAM_TABLE_COLUMNS = %i[title hours hours_with_coefficients price price_with_coefficients specialists_count description sum real_sum
          ...
          concat(content_tag(:td) do
            ...
            when :real_sum
              concat(content_tag(:div, style: 'display: flex; flex-direction: row; justify-content: space-between') do
                concat(task.public_send(attribute))
