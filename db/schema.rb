...
ActiveRecord::Schema.define(version: 20220820020232) do
  ...
  create_table "find_meds_components", force: :cascade do |t|
    t.text "name"
    t.text "comment"
    t.text "airtable_id"
    t.text "state"
  ...
  create_table "find_meds_drugs", force: :cascade do |t|
    t.text "name"
    t.text "comment"
    t.text "patent"
    t.text "airtable_id"
